...
bool DIApple525DiskStorage::readTrack(DIInt headIndex, DIInt trackIndex, DIData& data)
{
    if (headIndex)
        return false;
...
bool DIApple525DiskStorage::writeTrack(DIInt headIndex, DIInt trackIndex, DIData& data)
{
    if (headIndex)
        return false;
