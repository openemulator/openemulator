...
typedef enum
{
	...
	OEIMAGE_FORMAT_NTSC1A,
	OEIMAGE_FORMAT_NTSC1B,
	OEIMAGE_FORMAT_NTSC2,
	OEIMAGE_FORMAT_NTSC2A,
	OEIMAGE_FORMAT_NTSC2B,
	OEIMAGE_FORMAT_PAL1,
	OEIMAGE_FORMAT_PAL1A,
	OEIMAGE_FORMAT_PAL1B,
	OEIMAGE_FORMAT_PAL2,
	OEIMAGE_FORMAT_PAL2A,
	OEIMAGE_FORMAT_PAL2B,
	OEIMAGE_FORMAT_PAL3,
	OEIMAGE_FORMAT_PAL3A,
	OEIMAGE_FORMAT_PAL3B,
	OEIMAGE_FORMAT_PAL4,
	OEIMAGE_FORMAT_PAL4A,
